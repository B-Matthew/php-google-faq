  ...
  <body>
    ...
    <?php
      ...
      $db =[
        ...
        [
          ...
          [
             ...
             "b. Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.",
      ...
      foreach ($db as $value) {
        ...
        foreach ($value['text'] as $key => $paragraph) {
          echo '<p>' .$paragraph .'</p>';
        }
      }
      ?>
